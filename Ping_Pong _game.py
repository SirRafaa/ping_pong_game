...
velocidade_bola_x, velocidade_bola_y = 0.09, 0.09
...
def desenhar():
    ...
    pygame.draw.rect(janela, VERDE, (raquete1_x, raquete1_y, raquete_largura, raquete_altura))
    pygame.draw.rect(janela, VERDE, (raquete2_x, raquete2_y, raquete_largura, raquete_altura))
    pygame.draw.ellipse(janela, AMARELO, (bola_x, bola_y, bola_largura, bola_altura))
    

    placar_texto = font.render(f'{placar1} - {placar2}', True, AZUL)
